...
import orderbitImg from '../public/assets/projects/orderbit.png';
    ...
    <div className='w-full'>
      <div className='w-screen h-[50vh] relative'>
        ...
        <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
          <h2 className='py-2'>Orderbit ( Ecommerce Application - UK, London.)</h2>
          <h3>Next JS / TypeScript / Tailwind / Hasura / GraphQl / Ant Design</h3>
        </div>
      </div>
